 ...
 */
public class ComputingProjectFragment extends Fragment implements FragmentSettings {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_computing_project, container, false);

        //Sets the text size
        textView = (TextView) view.findViewById(R.id.computingProjectTextView);
